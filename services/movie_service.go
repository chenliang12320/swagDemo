...
type MovieService interface {
	...
	Add(movie *datamodels.Movie) (datamodels.Movie, error)
}
...
// add a movie
func (s *movieService) Add(movie *datamodels.Movie) (datamodels.Movie, error) {
	return s.repo.InsertOrUpdate(*movie)
}
